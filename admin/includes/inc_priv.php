...
//商品管理权限
    ...
    $purview['02_supplier_goods_list'] = 'supplier_goods_list';//TODO djs
    $purview['coupons']                = 'coupons';//提货券管理
    $purview['piaoduoduo_jingqu']      = 'piaoduoduo_jingqu';//票工厂景区管理

    
//供应商管理  //TODO djs 

    $purview['05_supplier_rank'] = 'supplier_rank';
    $purview['01_supplier_reg'] = 'supplier_reg';
    $purview['02_supplier_list'] = 'supplier_list';
//促销管理权限
...
//文章管理权限
    ...
    $purview['04_articlecat_list'] = 'articlecat_list';
...
//会员管理权限
    ...
    $purview['11_user_artificial']     = 'surplus_manage';
...
//订单管理权限
    ...
    $purview['02_supplier_order']    ='supplier_order';//TODO djs
    $purview['03_dongpiao_order']    = 'dongpiao_order';//TODO djs
    $purview['03_venues_order']      = 'venues_order';
    ...
    $purview['12_supplier_order_out']  = 'supplier_order_out';//TODO djs
    $purview['03_venues_order']        = 'venues_order';
	$purview['13_entity_goods_order']  = 'entity_goods_order';
    $purview['piaoduoduo_order']     = 'piaoduoduo_order';
...
//模板管理
    ...
    $purview['city_template_manage'] = 'city_template_manage';//TODO djs
...
//短信管理
    ...
    $purview['05_sms_send_history']  = 'sms_send_history';
