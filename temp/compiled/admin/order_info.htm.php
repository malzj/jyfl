...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
	...
	<td scope="col"><div align="center"><strong>是否退货</strong></div></td>
...
?>
	...
	<td><div align="center">
		<?php if ($this->_var['goods']['is_refund']): ?>
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
	...
	<?php if ($this->_var['operable_list']['prepare'] || $this->_var['operable_list']['split']): ?>
	<td colspan="2">
		<input name="invoice_no" type="text" style="color:#00F" value="请输入快递单号" onfocus="if (this.value == '请输入快递单号') this.value=''" />
