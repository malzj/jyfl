...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "SELECT COUNT(*) FROM " .$ecs->table("supplier_shipping_area").
            " WHERE shipping_id='$_POST[shipping]' AND shipping_area_name='$_POST[shipping_area_name]' AND supplier_id = '".intval($_SESSION['supplier_id'])."'";
    if ($db->getOne($sql) > 0)
    {
    ...
    else
    {
        ...
        $sql = "INSERT INTO " .$ecs->table('supplier_shipping_area').
                " (supplier_id, shipping_area_name, shipping_id, configure) ".
                "VALUES".
                " ('".intval($_SESSION['supplier_id'])."', '$_POST[shipping_area_name]', '$_POST[shipping]', '" .serialize($config). "')";
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    $sql = "SELECT COUNT(*) FROM " .$ecs->table("supplier_shipping_area").
            " WHERE shipping_id='$_POST[shipping]' AND ".
                    ...
                    "shipping_area_id<>'$_POST[id]' AND supplier_id = '".intval($_SESSION['supplier_id'])."'";
    if ($db->getOne($sql) > 0)
    {
        sys_msg($_LANG['repeat_area_name'], 1);
    }
...
{
    $sql = "SELECT * FROM " . $GLOBALS['ecs']->table('supplier_shipping_area') . " WHERE supplier_id = '".intval($_SESSION['supplier_id'])."'";
    if ($shipping_id > 0)
    {
