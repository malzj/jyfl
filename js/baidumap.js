...
var baidumap = {
	...
	options :{		
		// 显示多边形的api地址
		showUrl:'http://juyoufuli.com/jy/jyflapi/index.php?s=Peisong/Peisong/showmap',
		// 设置配送费用和供应商信息
		setPeisongUrl:'http://juyoufuli.com/jy/jyflapi/index.php?s=Peisong/Peisong/savaPeiSongMap',
		// 设置坐标信息的
		setZuobiaoUrl:'http://juyoufuli.com/jy/jyflapi/index.php?s=Peisong/Peisong/savePeiSongMapZuoBiao',
	...
	setYunfei:function(jiage, supplierid){
		$('#'+this.options.idClassFirst+"_"+supplierid).val(jiage);
		if(jiage == -1){
