        ...
        <section class="wrapper site-min-height" >
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal tasi-form" id="sv" enctype="multipart/form-data"  method="post" action="<?php echo U('Games/gameEdit');?>">
                        <input name="id" value="<?php echo ($game_info['id']); ?>" type="hidden" />
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">名称</label>
                            <div class="col-sm-10">
                                <input type="text" name="game_name" class="form-control" value="<?php echo ($game_info['game_name']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">总数(可购买数量)</label>
                            <div class="col-sm-10">
                                <input type="text" name="total" class="form-control" value="<?php echo ($game_info['total']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">每条点数</label>
                            <div class="col-sm-10">
                                <input type="text" name="point" class="form-control" value="<?php echo ($game_info['point']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="grade_id" class="form-control">
                                    ...
                                    <?php if(is_array($grade_list)): $i = 0; $__LIST__ = $grade_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>" <?php if($val['id']==$game_info['grade_id']) echo 'selected="selected"'?>><?php echo ($val["grade_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="status" class="form-control">
                                        <option value="0" <?php if($game_info['status']==0) echo 'selected="selected"'?>>关闭</option>
                                        <option value="1" <?php if($game_info['status']==1) echo 'selected="selected"'?>>开启</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="buy_status" class="form-control">
                                        <option value="0" <?php if($game_info['buy_status']==0) echo 'selected="selected"'?>>可购买</option>
                                        <option value="1" <?php if($game_info['buy_status']==1) echo 'selected="selected"'?>>点数售完</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img src="/jyflapi/Public/games/upload/<?php echo ($game_info['thumbnail']); ?>" width="200" />
                            </div>
                        </div>
                        <div class="form-group">
