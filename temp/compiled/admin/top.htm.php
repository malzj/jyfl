...
<div id="header-div">
  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 20px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
      ...
      <?php endif; ?>
       <a href="/index.php" class="fix-submenu" target="_blank">前台首页</a>
