/*TMODJS:{"version":24,"md5":"ff3c7e50f5fca9268c6065f969d7bb3b"}*/
...
$out+=$escape(validity);
$out+='。 </div> <div class="margin_top_15 mui-table-view"> <div class="mui-table-view-cell"> <h4 class="mui-pull-left">产品名称</h4> <p class="mui-pull-right">';
$out+=$escape(detail.productName);
$out+='</p> </div> <div class="mui-table-view-cell"> <h4 class="mui-pull-left">购买数量</h4> <div class="mui-numbox mui-pull-right" data-numbox-min=\'1\'> <button class="mui-btn mui-btn-numbox-minus" type="button">-</button> <input name="number" class="mui-input-numbox" type="number" value="" /> <button class="mui-btn mui-btn-numbox-plus" type="button">+</button> </div> </div> <div class="mui-table-view-cell"> <h4 class="mui-pull-left">单价</h4> <p class="mui-pull-right color_2fd0b5">';
...
$out+='</label> <input type="text" name="links[{$field.link}]" placeholder="';
$out+=$escape(tip[1]);
$out+='"> </div> ';
}
$out+=' ';
