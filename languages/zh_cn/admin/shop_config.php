...
$_LANG['cfg_name']['sms_domain'] = '域名';
$_LANG['cfg_name']['sms_user_name'] = '用户名';
$_LANG['cfg_name']['sms_password'] = '密钥';
$_LANG['cfg_name']['sms_content'] = '短信模版';
$_LANG['cfg_name']['sms_count'] = '发送短信条数';
$_LANG['cfg_name']['sms_total_money'] = '总共冲值金额';
$_LANG['cfg_name']['sms_balance'] = '余额';
$_LANG['cfg_name']['sms_last_request'] = '最后一次请求时间';
...
$_LANG['cfg_name']['api']      = '卡接口设置';
$_LANG['cfg_name']['skey']     = '接口密钥';
$_LANG['cfg_name']['dsource']  = '请求来源';
$_LANG['cfg_desc']['dsource']  = '1:portal, 2:凭证平台, 3：卡系统管理后台, 4：HTML5, 5：自助终端, 6：美时美刻';
$_LANG['cfg_name']['apiurl']   = '接口地址';
$_LANG['cfg_name']['saleId']   = '售卡机构';
$_LANG['cfg_name']['merchantId']  = '商户编号';
$_LANG['cfg_name']['storeId']     = '店面编号';
$_LANG['cfg_name']['deviceId']    = '设备编码';
$_LANG['cfg_name']['operId']      = '操作员编号';

$_LANG['cfg_name']['yyapi']      = '影院接口设置';
$_LANG['cfg_name']['yyapiurl']   = '接口地址';
$_LANG['cfg_name']['yyappUser']  = '客户端编码';
$_LANG['cfg_name']['yyappKey']   = '客户端密码';


$_LANG['cfg_name']['ycapi']      = '演出接口设置';
$_LANG['cfg_name']['ycapiurl']   = '接口地址';
$_LANG['cfg_name']['ycappUser']  = '商户名称';
$_LANG['cfg_name']['ycappKey']   = '接口密钥';
?>
