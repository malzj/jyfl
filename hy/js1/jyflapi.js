function userShow(data){
	...
	var user_id = $('#user_id').val();
            ...
            var xingqu_1;
            var img;
	var url="http://192.168.1.134/jyflapi/index.php?s=Users/User/userShow"
    $.ajax({
		type:"post",
		url:url,
		async:false,
...
function upload(data){
	 ...
	 var rudata ='';
     $.ajax({  
          url: 'http://192.168.1.134/jyflapi/index.php?s=Upload/Upload/upload' ,  
          type: 'POST',  
          data: formData,  
          async: false,  
          cache: false,  
...
//  判断是否有图片
	...
	var url="http://192.168.1.134/jyflapi/index.php?s=Users/User/userUpdate"
    $.ajax({
		type:"post",
		url:url,
		async:false,
