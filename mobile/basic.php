...
if ($_REQUEST['act'] == 'navList')
{
    ...
    $user_sql = 'SELECT u.nickname,u.pic,u.company_id,u.card_money,c.grade_id,c.company_name,c.logo_img,c.back_img,c.m_back_img FROM '.$GLOBALS['ecs']->table('users').' AS u LEFT JOIN '.$GLOBALS['ecs']->table('company').
