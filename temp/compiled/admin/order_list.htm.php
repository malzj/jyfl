...
?>
	...
	供货商：
	 <select name="supplier_id" id="supplier_id">
      <option value="-1">请选择</option>
	  <?php $_from = $this->_var['supplier_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'country');if (count($_from)):
    foreach ($_from AS $this->_var['country']):
?>
          <option value="<?php echo $this->_var['country']['supplier_id']; ?>"><?php echo $this->_var['country']['user_name']; ?></option>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </select>
...
?>
  <tr>
    ...
    <td align="center" valign="top" nowrap="nowrap"><?php if (( $this->_var['order']['return_status'] == 1 )): ?><font color="red">部分退货</font><?php endif; ?><?php if (( $this->_var['order']['return_status'] == 2 )): ?><font color="red">退货</font><?php endif; ?><?php echo $this->_var['lang']['os'][$this->_var['order']['order_status']]; ?>,<?php echo $this->_var['lang']['ps'][$this->_var['order']['pay_status']]; ?>,<?php echo $this->_var['lang']['ss'][$this->_var['order']['shipping_status']]; ?></td>
    <td align="center"><?php if ($this->_var['order']['source'] == 1): ?><font color=red>《无线》</font><?php else: ?><font color=green>《电脑》</font><?php endif; ?></td>
