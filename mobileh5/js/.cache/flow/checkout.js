/*TMODJS:{"version":380,"md5":"87f00e114c90e8d95f91126f867ef5ca"}*/
...
$out+='">';
$out+=$escape(data.total.goods_price_formated);
$out+='</span>点</a></div> <div class="mui-col-xs-5"> <a class="mui-tab-item footer_jiaru" href="#"><span class="mui-tab-label">去结算</span></a></div> </nav> <div id="showmap" style="display:none;"></div> <div class="mui-content"> <div class="mui-table-view"> <div class="mui-table-view-cell"> <a class="mui-navigate-right"> <h4>';
...
$out+='</p> </a> </div> </div> <form action="#" method="post" name="theForm" id="theForm"> ';
