                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <a  class="btn btn-primary" style="margin-right: 20px;margin-top:10px;float: right" href="<?php echo U('Grade/gradeAdd');?>">新增等级</a>
                            <table class="table table-striped" cellpadding=3 cellspacing=5>
                                ...
                                <?php if(is_array($grade_list)): $i = 0; $__LIST__ = $grade_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <a  href="<?php echo U('Grade/gradeEdit','id='.$vo['id']);?>">
                                                <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                                            </a>
                                            <a href="<?php echo U('Grade/gradeDelete','id='.$vo['id']);?>" onclick="return confirm('确定将此记录删除?')">
