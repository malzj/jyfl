			...
			<div class="reying">
				...
				<div class="reying_show">
					...
					<div class="reying_show2">
						...
						<div class="buy"><a href="<?php echo $this->_var['app_path']; ?>movie.php?step=planCinema&movieid=<?php echo $this->_var['movies']['shifuMovie']['movieId']; ?>" target="_blank">选座购票</a></div>
					</div>
				</div>
...
?>
							<li style="float: left;">
								...
								<div class="buy"> <a href="<?php echo $this->_var['app_path']; ?>movie.php?step=planCinema&movieid=<?php echo $this->_var['hot']['movieId']; ?>" target="_blank">选座购票</a></div>
							</a></div>
							</li>
						<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
