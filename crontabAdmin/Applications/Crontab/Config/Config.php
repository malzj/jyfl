...
class Config
{
    ...
    public static $adminPassword = 'huaying507';

}
// 建议使用绝对路径直接覆盖上面的参数配置
Config::$cron_dir = __DIR__ . '/../Crontab/cron_dir';
Config::$run_dir = __DIR__ . '/../Crontab/run_dir';
Config::$pid_dir = __DIR__ . '/../Crontab/pid_dir';
Config::$lock_dir = __DIR__ . '/../Crontab/lock_dir';
Config::$forbidden_dir = __DIR__ . '/../Crontab/forbidden_dir';
Config::$log_dir = __DIR__ . '/../Crontab/log_dir';
