...
$modules['02_cat_and_goods']['coupons']             = 'coupons.php?act=list';//提货券列表
$modules['02_cat_and_goods']['piaoduoduo_jingqu']   = 'piaoduoduo_jingqu.php?act=list';//景区列表
...
$modules['04_order']['03_film_order']               = 'film_order.php?act=list';
$modules['04_order']['03_ticket_order']             = 'dzqdh_order.php?act=list';
...
$modules['04_order']['user_coupons_order']      	= 'coupons_order.php?act=list';
//$modules['04_order']['12_film_order']             = 'excel.php?act=filmorder_excel';
//$modules['04_order']['12_ticket_order']             = 'excel.php?act=ticketorder_excel';
//$modules['04_order']['12_yanchu_order']             = 'excel.php?act=yanchuorder_excel';
...
//$modules['07_content']['04_articlecat_list']        = 'shiting.php?act=list';
$modules['07_content']['04_articlecat_list']        = 'cinema_list.php?act=list';
...
$modules['08_members']['09_user_account']           = 'user_account.php?act=list';//会员充值管理
$modules['08_members']['09_user_account_out']       = 'excel.php?act=chongzhi_execl';//会员充值列表导出
$modules['08_members']['10_user_account_manage']    = 'user_account_manage.php?act=list';
$modules['08_members']['11_user_artificial']    	= 'user_artificial.php?act=list';
...
$modules['12_template']['city_template_manage']     = 'city_template.php?act=list';
...
$modules['14_sms']['05_sms_send_history']           = 'sms.php?act=sms_send_history';
//$modules['14_sms']['06_sms_charge_history']         = 'sms.php?act=display_charge_history_ui';
$modules['14_sms']['07_sms_content']                = 'sms.php?act=send_content';
