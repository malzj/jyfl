...
?>
  ...
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
   <tr>
    <td class="label">是否供货商:</td>
    <td><input type="radio" name="is_supplier" value="0" <?php if (( $this->_var['user']['is_supplier'] == 0 )): ?>checked<?php endif; ?>>&nbsp;否&nbsp;<input type="radio" name="is_supplier" value="1" <?php if (( $this->_var['user']['is_supplier'] == 1 )): ?>checked<?php endif; ?>>&nbsp;是</td>
  </tr>
