...
<div id="pager">
	...
	<?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_15197800_1464054518');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_15197800_1464054518']):
?>
	<?php if ($this->_var['key'] == 'keywords'): ?>
	<input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo urldecode($this->_var['item_0_15197800_1464054518']); ?>" />
	<?php else: ?>
	<input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_15197800_1464054518']; ?>" />
	<?php endif; ?>
...
<div id="pager" class="manu">
	...
	<?php endif; ?>
	<?php if ($this->_var['pager']['page_count'] != 1): ?>
	<?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_15247700_1464054518');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_15247700_1464054518']):
?>
	<?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
	<span class="current"><?php echo $this->_var['key']; ?></span>
	<?php else: ?>
	<a href="<?php echo $this->_var['item_0_15247700_1464054518']; ?>"><?php echo $this->_var['key']; ?></a>
	<?php endif; ?>
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
	<?php endif; ?>
	...
	<?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_15286500_1464054518');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_15286500_1464054518']):
?>
	<?php if ($this->_var['key'] == 'keywords'): ?>
	<input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo urldecode($this->_var['item_0_15286500_1464054518']); ?>" />
	<?php else: ?>
	<input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_15286500_1464054518']; ?>" />
	<?php endif; ?>
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
