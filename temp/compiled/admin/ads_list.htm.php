...
<table cellpadding="3" cellspacing="1">
  <tr>
  	<th><a href="javascript:listTable.sort('listorder'); ">广告排序</a></th>
...
?>
  <tr>
    <td>
    <span onclick="javascript:listTable.edit(this, 'edit_listorder', <?php echo $this->_var['list']['ad_id']; ?>)"><?php echo $this->_var['list']['listorder']; ?></span>
    </td>
    <td class="first-cell">
