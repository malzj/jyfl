/*TMODJS:{"version":169,"md5":"37753ec25cc7bb62cc0f8110c0604e9a"}*/
...
$out+=' <a href="#"><span class="color_2fd0b5 mui-pull-right psfanwei shwo-yunfei" data-id="';
...
$out+=' <ul class="mui-table-view margin_top_15"> <li class="mui-table-view-cell"> 支付方式<span class="mui-pull-right color_8f8f94">聚优卡支付</span> </li> <li class="mui-table-view-cell"> 配送方式<span class="mui-pull-right color_8f8f94">供货商物流</span> </li> <li class="mui-table-view-cell"> 运费合计<span class="mui-pull-right color_8f8f94 yunfeiTotal">0</span> </li> </ul> </div>  <div class="row adress_select bg_white" style="display: none;"> <div class="adress_select_title"><h4 class="mui-text-center">配送地址</h4></div> <ul id="OA_task_2" class="mui-table-view"> <li class="mui-table-view-cell"> <div class="mui-slider-right mui-disabled"> <a class="mui-btn mui-btn-grey">编辑</a> <a class="mui-btn mui-btn-red add_adress_remove">删除</a> </div> <div class="mui-slider-handle"> <div class="mui-table-cell"> <p class="color_2fd0b5"> <span>王小雪</span> <span class="mui-pull-right">13820906181</span> </p> <p> <em class="adress_default">默认</em> <span>北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区</span> </p> </div> </div> </li> <li class="mui-table-view-cell"> <div class="mui-slider-right mui-disabled"> <a class="mui-btn mui-btn-grey">编辑</a> <a class="mui-btn mui-btn-red add_adress_remove">删除</a> </div> <div class="mui-slider-handle"> <div class="mui-table-cell"> <p class="color_2fd0b5"> <span>王小雪</span> <span class="mui-pull-right">13820906181</span> </p> <p> <em class="adress_default">默认</em> <span>北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区</span> </p> </div> </div> </li> <li class="mui-table-view-cell"> <div class="mui-slider-right mui-disabled"> <a class="mui-btn mui-btn-grey">编辑</a> <a class="mui-btn mui-btn-red add_adress_remove">删除</a> </div> <div class="mui-slider-handle"> <div class="mui-table-cell"> <p class="color_2fd0b5"> <span>王小雪</span> <span class="mui-pull-right">13820906181</span> </p> <p> <em class="adress_default">默认</em> <span>北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区</span> </p> </div> </div> </li> <li class="mui-table-view-cell"> <div class="mui-slider-right mui-disabled"> <a class="mui-btn mui-btn-grey">编辑</a> <a class="mui-btn mui-btn-red add_adress_remove">删除</a> </div> <div class="mui-slider-handle"> <div class="mui-table-cell"> <p class="color_2fd0b5"> <span>王小雪</span> <span class="mui-pull-right">13820906181</span> </p> <p> <em class="adress_default">默认</em> <span>北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区北京朝阳区</span> </p> </div> </div> </li> </ul> <div class="add_adress">添加新地址</div> </div>  <script type="text/javascript"> /*动态导入js*/ insertJs([\'js/baidumap.js\']); /* 选择时间 */ var result = mui(\'.select_date\')[0]; var btns = mui(\'#select_date\'); btns.each(function(i, btn) { btn.addEventListener(\'tap\', function() { var optionsJson = this.getAttribute(\'data-options\') || \'{}\'; var options = JSON.parse(optionsJson); var id = this.getAttribute(\'id\'); var picker = new mui.DtPicker(options); picker.show(function(rs) { result.value = rs.value; picker.dispose(); }); }, false); }); /* 拖拽后显示操作图标，点击操作图标删除元素； */ mui(\'#OA_task_2\').on(\'tap\', \'.add_adress_remove\', function(event) { var elem = this; var li = elem.parentNode.parentNode; mui.confirm(\'确认删除该条记录？\', \'提示\', [\'确认\', \'取消\'], function(e) { if (e.index == 0) { li.parentNode.removeChild(li); } else { setTimeout(function() { mui.swipeoutClose(li); }, 0); } }); }); var mask = mui.createMask(); jQuery(\'.mui-content\').on(\'tap\',\'.select_shouhuoAdress\',function(){ jQuery(\'.adress_select\').css(\'display\',\'block\'); mask.show(); }); jQuery(document).on(\'tap\',\'.mui-backdrop\',function(){ jQuery(\'.adress_select\').css(\'display\',\'none\'); }); /* 查看运费 */ jQuery(\'.mui-content\').on(\'tap\',function(){ }) /* 设置收货地址和运费 */ jQuery(\'.psfanwei\').each(function(index,dom){ supplierYunfei($(dom)); }); function supplierYunfei(dom){ var id = dom.attr(\'data-id\'); var addressHtml = dom.closest(\'.mui-row\').find(\'.supplier_shouhuoAddress\'); var yunfeiHtml = dom.closest(\'.mui-row\').find(\'.gys_yunfei\'); jQuery.ajaxJsonp(web_url+"/mobile/flow.php",{step:\'yunfei\',id:id},function(data){ /* 赋值 */ var _shippint_fee = data.data.shipping_fee; var _detail = data.data.detail; var _consignee = data.data.consignee; /* 设置配送地址 */ var address = _consignee.consignee+" "+_consignee.country_cn+" "+_consignee.province_cn+" "+_consignee.address; addressHtml.html(address); /* 运费计算 */ if(_detail.is_map == 1){ _initYunfei(_detail.supplier_id,address); }else{ yunfeiHtml.html(data.data.shipping_fee); } console.log(data); }); } function _initYunfei(sid, address){ baidumap.setOptions({ isYunfei:true, isSetYunfei:true, isTime:1, showMapId:\'showmap\', afterFunction:function(d){ if(d == -1){ mui.alert(\'当前地址不支持配送\'); }else{ totalYunfei(d); } } }); baidumap.showMap(sid,address); } /* 统计运费 */ function totalYunfei(d){ var yunfeiTotal = 0; jQuery(\'.supplier-one\').each(function(index,dom){ var yunfei = jQuery(dom).val(); if(yunfei != -1){ yunfeiTotal = parseInt(yunfeiTotal)+parseInt(yunfei); } }); jQuery(\'.yunfeiTotal\').html(yunfeiTotal); orderTotal = (parseFloat(yunfeiTotal)+parseFloat(jQuery(\'.orderTotal\').text())).toFixed(2); jQuery(\'.orderTotal\').html(orderTotal); } </script> ';
