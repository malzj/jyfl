...
<div id="header-div">
  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
	  ...
	  <!--<a href="../supplier.php?suppId=<?php echo $_SESSION['supplier_id']; ?>" target="_blank" class="fix-submenu">查看店铺网站</a>-->
    </div>
    <?php if ($this->_var['send_mail_on'] == 'on'): ?>
	...
	<img src="images/top_loader.gif" width="16" height="16" alt="<?php echo $this->_var['lang']['loading']; ?>" style="vertical-align: middle" /> <?php echo $this->_var['lang']['loading']; ?></div>
  </div>
</div>
<div id="menu-div">
  <ul>
